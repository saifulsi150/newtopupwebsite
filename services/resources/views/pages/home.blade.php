            ...
            <li class="carousel__slide">
              <div class="carousel__item">
                 ...
                 <a href="{{ $slider->url }}" target="_blank">
                  <img src="{{ get_image($slider->image_url) }}" class="rounded-md" @if ($loop->first) fetchpriority="high" loading="eager" @else loading="lazy" @endif decoding="async">
                 </a>
                @else
                  <img src="{{ get_image($slider->image_url) }}" class="rounded-md" @if ($loop->first) fetchpriority="high" loading="eager" @else loading="lazy" @endif decoding="async">
                @endisset
...
<!--- products --->
                          ...
                          <div class="cursor-pointer">
                            ...
                            <div class="inset-0 transform hover:scale-90 transition duration-300">
                              <div class="h-full w-full text-center mx-auto">
                                <img src="{{ get_product_image($product) }}" class="rounded-md" loading="lazy" decoding="async">
                              </div>
                            </div>
                          </div>
                          <div>
    ...
    <script src="{{ asset('assets/template/js/slider.js') }}" defer></script>
